                        ...
                        <div className="d-flex align-items-center justify-content-between">
                            ...
                            <div className="eltio_k2">
                                <a href="#" data-toggle="modal" data-target="#login1" className="btn btn-block custom-height bg-dark mb-2">
                                    <i className="lni lni-shopping-basket mr-2"></i>Add Address
                                </a>
                            </div>
                        </div>
                        <hr />
                        ...
                        <tbody>
                            {address.map((item, index)=>{
                                ...
                                <tr key={item.id}>
                                    ...
                                    <td>{item.pincode}</td>
                                    <td>{item.country}</td>
                                    <td><button class="btn btn-danger" onClick={() => deleteAddressDataHandler(item.id)}><i class="fas fa-trash-alt"></i></button></td>
                                </tr>
                                )
                            })}
                        </tbody>
