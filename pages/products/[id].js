...
export default function Product({ userToken }) {
    ...
    return (
        <Layout cartSection={cartSection} userToken={userToken}>
            ...
            <KidModal modalCloseBtn={modalCloseBtn} name={name} nameError={nameError} nameErrorMsg={nameErrorMsg} nameHandler={nameHandler} gender={gender} genderHandler={genderHandler} schoolId={scholId} school={school} schoolIdError={scholIdError} schoolIdHandler={scholIdHandler} clasErrorMsg={clasErrorMsg} clas={clas} clasSelect={clasSelect} clasHandler={clasHandler} clasError={clasError} section={section} sectionError={sectionError} sectionErrorMsg={sectionErrorMsg} sectionHandler={sectionHandler} sectionSelect={sectionSelect} addKidHandler={addKidHandler} />
