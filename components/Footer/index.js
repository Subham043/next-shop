					...
					<div className="row">
						...
						<div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div className="d-flex align-items-center justify-content-start py-2">
								<div className="d_ico">
									<i className="fas fa-shopping-basket theme-cl"></i>
								</div>
						...
						<div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div className="d-flex align-items-center justify-content-start py-2">
								<div className="d_ico">
									<i className="far fa-credit-card theme-cl"></i>
								</div>
								<div className="d_capt">
						...
						<div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div className="d-flex align-items-center justify-content-start py-2">
								<div className="d_ico">
									<i className="fas fa-shield-alt theme-cl"></i>
								</div>
								<div className="d_capt">
						...
						<div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div className="d-flex align-items-center justify-content-start py-2">
								<div className="d_ico">
									<i className="fas fa-headphones-alt theme-cl"></i>
								</div>
								<div className="d_capt">
